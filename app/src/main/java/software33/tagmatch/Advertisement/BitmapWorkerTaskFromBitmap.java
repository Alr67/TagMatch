...
public class BitmapWorkerTaskFromBitmap extends AsyncTask<String, Void, Bitmap> {
    ...
    public BitmapWorkerTaskFromBitmap(CustomPagerAdapterViewAdvert parent) {
    ...
    protected void onPostExecute(Bitmap bitmap) {
        if (ActivityReference != null && bitmap != null) {
            final CustomPagerAdapter imageView = ActivityReference.get();
            if (imageView != null) {
                imageView.newImageConverted(bitmap);
            }
        }
    }
}